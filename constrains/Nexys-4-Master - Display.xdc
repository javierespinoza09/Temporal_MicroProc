...
set_property PACKAGE_PIN U9 [get_ports {Dis0[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis0[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {Dis0[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis0[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {Dis0[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis0[2]}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {Dis0[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis0[3]}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
set_property PACKAGE_PIN R5 [get_ports {Dis1[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis1[0]}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports {Dis1[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis1[1]}]
##Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
set_property PACKAGE_PIN V6 [get_ports {Dis1[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis1[2]}]
##Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
set_property PACKAGE_PIN V5 [get_ports {Dis1[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis1[3]}]
##Bank = 34, Pin name = IO_L8P_T1-34,						Sch name = SW8
set_property PACKAGE_PIN U4 [get_ports {Dis2[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis2[0]}]
##Bank = 34, Pin name = IO_L9N_T1_DQS_34,					Sch name = SW9
set_property PACKAGE_PIN V2 [get_ports {Dis2[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis2[1]}]
##Bank = 34, Pin name = IO_L9P_T1_DQS_34,					Sch name = SW10
set_property PACKAGE_PIN U2 [get_ports {Dis2[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis2[2]}]
##Bank = 34, Pin name = IO_L11N_T1_MRCC_34,					Sch name = SW11
set_property PACKAGE_PIN T3 [get_ports {Dis2[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis2[3]}]
##Bank = 34, Pin name = IO_L17N_T2_34,						Sch name = SW12
set_property PACKAGE_PIN T1 [get_ports {Dis3[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis3[0]}]
##Bank = 34, Pin name = IO_L11P_T1_SRCC_34,					Sch name = SW13
set_property PACKAGE_PIN R3 [get_ports {Dis3[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis3[1]}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
set_property PACKAGE_PIN P3 [get_ports {Dis3[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis3[2]}]
##Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
set_property PACKAGE_PIN P4 [get_ports {Dis3[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Dis3[3]}]
...
#set_property PACKAGE_PIN F15 [get_ports Load]						
	#set_property IOSTANDARD LVCMOS33 [get_ports Load]
##Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
#set_property PACKAGE_PIN T16 [get_ports DIR[1]]						
	#set_property IOSTANDARD LVCMOS33 [get_ports DIR[1]]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
#set_property PACKAGE_PIN R10 [get_ports DIR[0]]						
...
##Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4 //MSB
set_property PACKAGE_PIN E17 [get_ports {JA[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JA[3]}]
##Bank = 15, Pin name = IO_0_15,								Sch name = JA7 //PULSO
