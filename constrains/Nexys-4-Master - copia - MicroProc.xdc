...
#set_property PACKAGE_PIN B13 [get_ports {D}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {D}]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
#set_property PACKAGE_PIN F14 [get_ports {C}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {C}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
#set_property PACKAGE_PIN B16 [get_ports {B}]				
	#set_property IOSTANDARD LVCMOS33 [get_ports {B}]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
#set_property PACKAGE_PIN E17 [get_ports {A}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {A}]
##Bank = 15, Pin name = IO_0_15,								Sch name = JA7
#set_property PACKAGE_PIN G13 [get_ports {E}]					
